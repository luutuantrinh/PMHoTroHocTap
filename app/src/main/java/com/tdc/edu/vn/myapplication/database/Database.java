...
public class Database extends SQLiteOpenHelper {
    ...
    public void init(){
        ...
        float rateToRoot30 = (float) 1000;

        String unitName31 =  "BYTE";
        float rateToRoot31 = (float) 0.001;

        String unitName32 =  "KB";
        float rateToRoot32 = (float) 1;

        String unitName33 =  "GB";
        float rateToRoot33 = (float) 1000000;

        String unitName34 =  "TB";
        float rateToRoot34 = (float) 1000000000;
    ...
    public void initType(){
        ...
        convertTypesList.add(new ConvertType("3", "weight", "g, kg, ton...", R.drawable.ic_function_power));
